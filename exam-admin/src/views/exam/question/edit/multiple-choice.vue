  ...
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading"  :rules="rules">
      <el-form-item label="类别：" prop="ceId" required>
        <el-select v-model="form.ceId" placeholder="类别"  @change="levelChange">
          <el-option v-for="item in subjectFilter" :key="item.ceId" :value="item.ceId" :label="item.ceName"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="创建人:" prop="tid" v-show="true" >
      ...
      <el-form-item label="解析：" prop="comment" required>
        <el-input v-model="form.comment"  @focus="inputClick(form,'analyze')" />
      </el-form-item>
      ...
      <el-form-item label="正确答案：" prop="answerArray" required>
