<template>
  <div class="app-container">
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item label="类别：">
        <el-select v-model="queryParam.level" placeholder="类别"  @change="levelChange" clearable>
          <el-option v-for="item in subjects" :key="item.ceId" :value="item.ceId" :label="item.ceName"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="ceId" label="学科" :formatter="subjectFormatter" width="120px"/>
      <el-table-column prop="type" label="题型"  width="70px"/>
      <el-table-column prop="ename" label="题干" show-overflow-tooltip/>
      <el-table-column prop="score" label="分数" width="60px"/>
      <el-table-column prop="difficulty" label="难度" width="60px"/>
      <el-table-column prop="createTime" label="创建人" width="160px"/>
