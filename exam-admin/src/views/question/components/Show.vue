<template>
  <div style="line-height:1.8">
    <div v-if="qType==1" v-loading="qLoading">
      <div class="q-title" v-html="question.ename"/>
      <div class="q-content">
          <span :key="item" v-for="item in question.items" class="q-item-contain">
            <span class="q-item-prefix">{{item.prefix}}</span>
            <span v-html="item.comment" class="q-item-content"></span>
          </span>
      </div>
    </div>
