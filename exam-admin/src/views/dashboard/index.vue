      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="examAllCount" :duration="2600" class="card-panel-num" v-loading="loading"/>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" >
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="curriculumAllCount" :duration="3000" class="card-panel-num" v-loading="loading"/>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="exercisesAllCount" :duration="3600" class="card-panel-num" v-loading="loading"/>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
...
export default {
  ...
  mounted () {
    ...
    dashboardApi.index().then(re => {
      ...
      _this.examAllCount = response.examAllCount
      _this.exercisesAllCount = response.exercisesAllCount
      _this.curriculumAllCount = response.curriculumAllCount
