  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/exam/question/edit/single-choice'),
        name: 'singleChoicePage',
        meta: { title: '单选题编辑', noCache: true }
      },
      {
        path: 'edit/multipleChoice',
        component: () => import('@/views/exam/question/edit/multiple-choice'),
        name: 'multipleChoicePage',
        meta: { title: '多选题编辑', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '课程编辑', noCache: true, activeMenu: '/education/subject/list' }
      }
    ]
  },
  {
